                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <div>
                                        ...
                                        <input autocomplete="off" id="id_produto5" class='text-box form-control' name="produto" rows="1" placeholder="Selecione o produto" value="<?php echo ($descricao); ?>">
                                    </div>

                                    <div class="row">
                                        <div class="col">
                                            <strong>Qtde:</strong><br>
                                            <input class='text-box form-control' id="qtd_compra_editar6" type='number' name="qtd" rows="1" placeholder="Digite a quantidade" value="<?php echo ($qtd); ?>">
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <input class='text-box form-control' id="vunitario_compra6" type="text" min="0" step="0.010" name="valor_unitario" rows="1" placeholder="R$" value="<?php echo ($valor_unitario); ?>" onkeyup="formatarMoeda('vunitario_compra6')">
                                        </div>

                                        <div class="col">
                                            <strong>Valor total:</strong><br>
                                            <input class='text-box form-control' id="vtotal_compra6" type="text" min="0" step="0.010" name="valor_total" rows="1" placeholder="R$" value="<?php echo ($valor_total); ?>" onkeyup="formatarMoeda('vtotal_compra6')">
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <input class='text-box form-control' autocomplete="off" name="observacao" rows="2" placeholder="Digite uma observação" value="<?php echo ($observacao); ?>">
                                    </div><br>
                ...
                <section>
                    ...
                    <script>
                        ...
                        $(document).ready(function() {
                            $("#qtd_compra_editar6, vunitario_compra6").change(function() {
