...
?>
        ...
        <head>
            ...
            <title>Custo - Itens da Nota</title>
            <?php $menu->getHead(); ?>
        ...
        <body>
            ...
            <section class='container'>
                ...
                <legend class="title h1 text-center mb-4 mt-4">Itens da nota</legend>
                            ...
                            <div class="card shadow-small p-3 mb-2 bg-white rounded">
                                <div class="row">
                                    ...
                                    <div class="left m-3">
                                        ...
                                        <strong>Classificação:</strong> <?php echo ($array['classificacao'] = isset($array['classificacao']) ? $array['classificacao'] : '-'); ?><br>
                                        <strong>Quantidade:</strong> <?php echo ($array['qtd']); ?><br>
                                        <strong>Valor unitário:</strong> <?php echo ($array['valor_unitario'] = number_format($array['valor_unitario'], 2, '.', '')); ?><br>
                                        <strong>Valor total:</strong> <?php echo ($array['valor_total'] = number_format($array['valor_total'], 2, '.', '')); ?><br>
                                ...
                                <div class='justify-content-center text-center'>
                                    <button name="btn_editar_itens_compra" type="submit" class="btn btn-link p-1" value="<?php echo ($tag_de_contagem); ?>">
                                        <span class="material-icons btn_acoes cor_editar">edit</span>
                                    </button>
                                    <button name="btn_apagar_itens_compra" type="submit" class="btn btn-link p-1" value="<?php echo ($tag_de_contagem); ?>">
