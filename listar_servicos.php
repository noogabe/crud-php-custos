                ...
                <ul class="pagination justify-content-center">
                    <li class="page-item">
						...
						if($pagina_anterior != 0){ ?>
							<a class="page-link text-success" href="listar_servicos.php?pagina=<?php echo ($pagina_anterior);?>" aria-label="Previous">
                    ...
                    for($i = 1; $i < $num_paginas +1 ; $i++){ ?>
                        <li <?php if($i == $pagina) { ?> class="page-item active" <?php } ?> class="page-item">
                            <a class="page-link text-success" href="listar_servicos.php?pagina=<?php echo ($i);?>"><?php echo ($i);?></a>
                        </li>
                    ...
                    <?php
						if($pagina_posterior <= $num_paginas){ ?>
							<a class="page-link text-success" href="listar_servicos.php?pagina=<?php echo ($pagina_posterior);?>" aria-label="Next">
