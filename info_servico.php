...
<html lang="pt-br">
    <head>
        <title>Custo - Informações do Serviço</title>
        <?php $menu->getHead(); ?>
    </head>
    <body>
        <!--Sidebar-->
        ...
        <section class='container'>
            <legend  class="title h1 text-center mb-4 mt-4">Informações do Serviço</legend>
            ...
            <div class="card shadow-small p-3 mb-2 bg-white rounded">
                ...
                <?php
                    ...
                    $tipo_manutencao = $_GET['tipo_manutencao'];
                ...
                <div class="row">
                    ...
                    <div class="text-left m-3">
                        ...
                        <strong>Tipo de manutenção:</strong> <?php echo ($tipo_manutencao); ?><br>
